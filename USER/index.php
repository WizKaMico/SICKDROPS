...
$result=mysqli_query($conn, "select * from user where user_id='$session_id'")or die('Error In Session');
...
?>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								<a href="index.php?view=HOME" style="color:#e9301c;">Hi! <?php echo $row['fullname']; ?></a>
							</li>
	...
	<?php include('action/specific.php'); ?>
	<?php } else { ?>
