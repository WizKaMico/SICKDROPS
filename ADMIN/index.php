    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
               ...
               <?php } ?>  
                ...
                <?php if($_GET['view'] == 'ORDER'){ ?> 
                <li class="active">
                    <a href="index.php?view=<?php echo 'ORDER'; ?>">
                ...
                <?php } ?>
                  ...
                  <?php if($_GET['view'] == 'CUSTOMORDER'){ ?> 
                <li class="active">
                    <a href="index.php?view=<?php echo 'CUSTOMORDER'; ?>">
                        <i class="pe-7s-news-paper"></i>
                        <p>Custom Order</p>
                    </a>
                </li>
                ...
                <li class="active">
                    <a href="index.php?view=<?php echo 'USER'; ?>">
                        <i class="pe-7s-news-paper"></i>
                        <p>Admin</p>
                    </a>
                </li>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php } else if($_GET['view'] == 'CUSTOMORDER'){?>    
                    <?php include('includes/customorder.php'); ?>   
